...
foreach (string line in System.IO.File.ReadLines(@"C:\Users\Kaya\Desktop\data\data.tsv").Skip(1).Take(1000))
{
...
bool ConvertToBool(string input)
{
    ...
    throw new ArgumentException("Kolonne er ikke 01 eller 1, men" + input);
}
